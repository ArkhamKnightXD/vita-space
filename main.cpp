...
int main(int argc, char *args[]) {
    ...
    shipSprite = loadSprite("mystery.png", SCREEN_WIDTH, 40);

    mysteryShip = {SCREEN_WIDTH, shipSprite, 50, -200, false, false};

    aliens = createAliens();

    playerSprite = loadSprite("spaceship.png", SCREEN_WIDTH / 2, SCREEN_HEIGHT - 40);
    ...
    structureSprite = loadSprite("structure.png", 120, SCREEN_HEIGHT - 120);
